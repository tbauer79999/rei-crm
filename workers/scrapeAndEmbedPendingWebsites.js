...
async function processPendingContent() {
  console.log('🚀 Starting processPendingContent function...');
  ...
  try {
    ...
    console.log(`📊 Query result - Items: ${pendingItems?.length || 0}, Error: ${error || 'none'}`);
    ...
    console.error('💥 Global error in processPendingContent:', globalError);
