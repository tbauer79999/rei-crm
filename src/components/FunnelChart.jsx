...
const colorMap = {
  'bg-blue-500': '#60a5fa',     // bg-blue-400
  'bg-green-500': '#34d399',    // bg-green-400
  'bg-yellow-500': '#facc15',   // unchanged
  'bg-red-500': '#f87171'       // bg-red-400
};


  return (
    <div className="p-4">
      <h2 className="text-xl font-semibold mb-4 text-center text-gray-800">Lead Temperature Funnel</h2>
